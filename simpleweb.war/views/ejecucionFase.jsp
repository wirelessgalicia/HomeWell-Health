...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script language="javascript" type="application/javascript" src="../js/myjs/ejecucionFase.js"></script>
    	...
    	<div class="wide_content">			
                <div class="title"><fmt:message key="ejecFasejsp.fase" /> ${orden} : ${descripcion} </div>
					<div id="result_container">			
						<p>
						<fmt:message key="ejecFasejsp.iniciada" />
						<br /><br />
						</p> 
						<p>
					   ...
					   <div>
                        ...
                        <a id="btStop" class="read_more" href="#">
							<div class="enlace_tab"><fmt:message key="ejecFasejsp.parar" /></div>
                        </a>
                        </div>
						<div class="col1">
