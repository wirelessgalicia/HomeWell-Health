...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script language="javascript" type="application/javascript" src="../js/myjs/ejecucionFasePulsoCiclo.js"></script>
...
<div class="main_content_pulso_ciclo">
    	<div class="wide_content_pulso_ciclo">			
                <div class="title"><fmt:message key="ejecFasejsp.fase" /> ${orden} : ${descripcion} </div>
					<div id="result_container_pulso_ciclo">			
						<div class="col1_ini">			
							<p>
						...
						<div class="col1">
							<div class="colLarge_rpm">
								<div class="colRight">
									<div class="font_grafica">
										<div id="chartRpm" style="width:400px;height:250px;"></div>
									</div>
						...
						<div class="col3">
							<div class="font_grafica">
								<div id="chartSat" style="width:400px;height:250px;"></div>
							</div>
							<div class="legend_x"><fmt:message key="milisegundos" /></div>
						</div>
						<div class="col3">
