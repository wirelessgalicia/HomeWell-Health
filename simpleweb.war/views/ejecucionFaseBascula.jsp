...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script language="javascript" type="application/javascript" src="../js/myjs/ejecucionFaseBascula.js"></script>
...
<div class="main_content">
    	<div class="wide_content">			
				...
				<div id="result_container">			
					<div class="colBascula1">			
							<p>
								<fmt:message key="ejecFaseBasculajsp.iniciocorrecto" />
								<br /><br />
								<fmt:message key="ejecFaseBasculajsp.comprobe" />
								<br /><br />
							</p> 
							<p>
						...
						<div class="colBascula2">
							<div class="desc_bascula">
								<p>
								<fmt:message key="ejecFaseBasculajsp.estabilicepeso" />
								</p>
								<img src="../images/d_peso.jpg" alt="persona subida a una bascula"/>
							</div>
						</div>
						
						<div class="colBascula3">
							<div class="title"><fmt:message key="ejecFaseBasculajsp.peso" /></div>
							<br><br>
							<div class="bascula">
                					<input id="txtPeso" type="text" value="" READONLY/>
                					<div id="txtKg">Kg</div>
					  		</div>
						</div>
